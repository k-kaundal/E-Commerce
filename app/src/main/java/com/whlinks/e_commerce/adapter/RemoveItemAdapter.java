...
public class RemoveItemAdapter extends RecyclerView.Adapter<RemoveItemAdapter.ViewHolder> {
    ...
    public RemoveItemAdapter(List<Item> itemList1, Context context) {
...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item, parent,false);
        return new RemoveItemAdapter.ViewHolder(view);
    }
...
//    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RemoveItemAdapter.ViewHolder holder, int position) {
...
//        holder.itemImage.set;
        ...
        holder.removeToFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                commonDBCall.removeItem(itemList.get(position).getDoc_id(), context);
