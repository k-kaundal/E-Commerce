...
public class RemoveLatestItemAdapter extends RecyclerView.Adapter<RemoveLatestItemAdapter.ViewHolder> {

    List<Item> itemList;
    private Context context;
    CommonDBCall commonDBCall = new CommonDBCall();

    public RemoveLatestItemAdapter(List<Item> itemList1, Context context) {
...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_item, parent,false);
        return new RemoveLatestItemAdapter.ViewHolder(view);
    }
...
//    }
    ...
    @Override
    public void onBindViewHolder(@NonNull RemoveLatestItemAdapter.ViewHolder holder, int position) {
...
//        holder.itemImage.set;
        ...
        holder.removeToFavorite.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                commonDBCall.removeLatestItem(itemList.get(position).getDoc_id(), context);
            }
        });
