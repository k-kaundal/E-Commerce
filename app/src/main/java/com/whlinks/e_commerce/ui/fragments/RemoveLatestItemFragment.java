...
import com.whlinks.e_commerce.adapter.RemoveLatestItemAdapter;
 ...
 * Use the {@link RemoveLatestItemFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RemoveLatestItemFragment extends Fragment {


    public RemoveLatestItemFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_remove_latest_item, container, false);
...
//                   itemList1.add(itemList.get(i).getData());
                ...
                if (itemList1 == null){
                    ...
                    recyclerView.setAdapter(new RemoveLatestItemAdapter(itemList1, getActivity()));
                }
