...
//        recyclerViewTop = view.findViewById(R.id.recyclerViewTop);
        ...
        listItems.add(new The_Slide_Items_Model_Class(R.drawable.items2, "Best Electrician Items"));
//        listItems.add(new The_Slide_Items_Model_Class(R.drawable.item3,"Slider 3 Title"));
        ...
        TabLayout tabLayoutbottom = view.findViewById(R.id.tabLayout);
        tabLayoutbottom.addTab(tabLayoutbottom.newTab().setText("Top Items"));
        tabLayoutbottom.addTab(tabLayoutbottom.newTab().setText("Latest Items"));
        tabLayoutbottom.addTab(tabLayoutbottom.newTab().setText("All Items"));
...
////            setTitle("Home");
            getActivity().getSupportFragmentManager().
                    beginTransaction().replace(R.id.framelayout, new TopItemsFragment()).commit();
        }
        tabLayoutbottom.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        fragmentManager.
                                beginTransaction().replace(R.id.framelayout, new LatestItemFragment()).commit();
                        break;
                    case 2:
                        fragmentManager.
                                beginTransaction().replace(R.id.framelayout, new AllItemFragment()).commit();
                        break;
